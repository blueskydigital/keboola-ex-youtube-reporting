...
export function parseConfiguration(configObject) {
  return new Promise((resolve, reject) => {
    ...
    // Read includeSystemManaged parameter which allows to download special reports generated by Google automatically.
    const includeSystemManaged = !isUndefined(configObject.get('parameters:includeSystemManaged'))
      ? configObject.get('parameters:includeSystemManaged')
      : DEFAULT_SYSTEM_MANAGED_INCLUDED;
